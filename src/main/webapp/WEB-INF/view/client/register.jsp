			...
			<div class="card-body">
				...
				<form>
					<div class="mb-2">
						...
						</label> <input class="form-control " type="text" id="username"
							name="username" required />
					</div>
					<div class="mb-2">
						<label class="form-label" for="userpass">Mật khẩu <span
							class="text-danger">*</span></label> <input class="form-control"
							id="userpass" name="userpass" type="password " required>
					</div>
					<div class="mb-2">
					...
					<div class="mb-2 d-flex justify-content-around">
						<div class="form-check me-2">
							<label class="form-check-label" for="nam">Nam</label> <input
								class="form-check-input" type="radio" name="usergender" id="nam"
								checked>
						</div>
						<div class="form-check me-2">
							<label class="form-check-label" for="nu">Nữ</label> <input
								class="form-check-input" id="nu" type="radio" name="usergender">
						</div>
					</div>
					<div class="mb-2">
						<label class="form-label" for="email">Email<span
							class="text-danger">*</span></label> <input class="form-control"
							id="email" name="useremail " type="email">
					</div>
					<div class="mb-2">
