...
<header id="header" class="header fixed-top d-flex align-items-center">
	<div class="d-flex align-items-center justify-content-between">
		<a href="${pageContext.request.contextPath}/"
			...
			class=" d-lg-block hover-primary">Countduck</span>
	...
	<nav class="header-nav ms-auto">
		<ul class="d-flex align-items-center">
			<li class="nav-item dropdown pe-3"><a
				...
				data-bs-toggle="dropdown"> <img src="../img/add.png"
					alt="Profile" class="rounded-circle" /> <span
					class="d-none d-md-block dropdown-toggle ps-2">Phí Hoàng Anh</span>
			</a>
			<!-- End Profile Iamge Icon -->
				...
				<ul
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="${contextPage.request.contextPath}/logout}"> <i class="bi bi-box-arrow-right"></i> <span>Sign
								Out</span>
					</a></li>
